...
public class DocumentController {
    ...
    @GetMapping({"/documents/authority/{id}/list"})
    public String getDocumentsForAuthority(@PathVariable String id, Model model)
    {
        log.debug("Getting document for Authority ID: " + id);
        model.addAttribute("documents", documentService.getDocumentsForAuthority(Long.valueOf(id)));
